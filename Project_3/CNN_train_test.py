...
"""
print('Loading data......')
sub_train_images, sub_train_labels, sub_test_images, sub_test_labels = init_subset('0343') # input your ASUID last 4 digits here to generate the subset samples of MNIST for training and testing
...
def plot_graphs(data,epochs,chart): #this is a function to plot graphs
...
plot_graphs(train_acc_vals,epochs,'Training Accuracy')
plot_graphs(train_loss_vals,epochs,'Training Loss')
plot_graphs(test_acc_vals,epochs,'Testing Accuracy')
plot_graphs(test_loss_vals,epochs,'Testing Loss')
